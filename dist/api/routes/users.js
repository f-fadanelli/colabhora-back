...
// src/api/routes/users.ts
function users_default(router) {
  router.post("/user/validate", validate(validateUserSchema, "body"), postUserLogin), router.get("/user", validate(getUserSchema, "query"), authenticateToken("default"), getUsers), router.get("/user/skills", validate(getSkillsByUserSchema, "query"), authenticateToken("default"), getUserSkills), router.post("/user", validate(postUserSchema, "body"), postUser);
